...
func (h *AccountHandler) refreshSingleAccount(ctx context.Context, account *service.Account) (*service.Account, string, error) {
	...
	if account.IsOpenAI() {
		...
		// Gemini OAuth token refresh is no longer supported
		return nil, "", fmt.Errorf("gemini platform is no longer supported")
...
// Gemini tier refresh removed (Gemini platform removed)
func (h *AccountHandler) RefreshTier(c *gin.Context) {
	response.BadRequest(c, "Gemini tier refresh is no longer supported")
}
