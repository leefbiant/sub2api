...
func (s *RateLimitService) PreCheckUsage(ctx context.Context, account *Account, requestedModel string) (bool, error) {
	// Gemini precheck removed (Gemini platform removed)
	return true, nil
}
...
func (s *RateLimitService) GeminiCooldown(ctx context.Context, account *Account) time.Duration {
	...
	// Gemini cooldown removed (Gemini platform removed)
	return 5 * time.Minute
}
...
func (s *RateLimitService) handle403(ctx context.Context, account *Account, upstreamMsg string, responseBody []byte) (shouldDisable bool) {
	// Antigravity 403 handling removed
	return s.handleGeneric403(ctx, account, upstreamMsg)
}

func (s *RateLimitService) handleGeneric403(ctx context.Context, account *Account, upstreamMsg string) (shouldDisable bool) {
	// Default 403 handling
	s.handleAuthError(ctx, account, "Forbidden (403): "+upstreamMsg)
	return true
}

// handleAntigravity403 is removed - was used for Antigravity platform 403 handling
...
func (s *RateLimitService) handle429(ctx context.Context, account *Account, headers http.Header, responseBody []byte) {
	...
	if resetTimestamp == "" {
		...
		// NOTE: Anthropic handling removed (Anthropic platform removed)
...
func (s *RateLimitService) tryTempUnschedulable(ctx context.Context, account *Account, statusCode int, responseBody []byte) bool {
	...
	// NOTE: Antigravity handling removed (Anthropic platform removed)
